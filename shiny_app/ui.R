...
ui <- dashboardPage(
  dashboardHeader(
    ...
    tags$li(
      a(href = "https://github.com/your-project-repo", target = "_blank", "GitHub", class = "dropdown-item"),
      class = "dropdown"
    ),
    tags$li(
  ...
  dashboardBody(
    ...
    tags$head(
      tags$style(HTML("
        /* Cambia lo sfondo del logo (titolo) */
        .main-header .logo {
...
fluidRow(
  column(
    ...
    div(style = "margin-bottom: 30px;",
        fileInput("gene_calls", "Upload Gene Call Table", accept = c(".csv", ".tsv", ".txt")),
        ...
        p("If no files are uploaded, the application will use the sample dataset"),
